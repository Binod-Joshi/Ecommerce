    ...
    return (
        <>
            <React.Fragment>
                ...
                <ListItemButton
                    component={Link} to="/Seller/addproducts"
                    sx={location.pathname.startsWith('/Seller/addproducts') ? styles.currentStyle : styles.normalStyle}
                >
                    <ListItemIcon>
                        <AddCardIcon sx={{ color: location.pathname.startsWith('/Seller/addproducts') ? '#4d1c9c' : 'inherit' }} />
                    </ListItemIcon>
